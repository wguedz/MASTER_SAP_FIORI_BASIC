		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#logaligroupcomsapui5-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"logaligroupcomsapui5-display": {
								"semanticObject": "logaligroupcomsapui5",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=logaligroup.com.sapui5",
									"url": sap.ui.require.toUrl("logaligroup/com/sapui5")
								}
							}
						}
					}
